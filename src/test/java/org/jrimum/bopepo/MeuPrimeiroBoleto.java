...
public class MeuPrimeiroBoleto {
	...
	final Titulo crieOsDadosDoNovoTitulo(Titulo titulo) {
		...
		titulo.setNossoNumero("00000001");
	...
	final ContaBancaria crieUmaContaBancaria(){
		...
		contaBancaria.setNumeroDaConta(new NumeroDaConta(26560, "0"));
		contaBancaria.setCarteira(new Carteira(30));
		contaBancaria.setAgencia(new Agencia(leftPad("123", "0", 4), "1"));
	...
	final String leftPad(String str, String character, int size) {
		if (str != null){
